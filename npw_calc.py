...
stats_df.plot(x='NPV', y='cdf', ax=ax, color='r', label='NPV (Stochastic)')
ax.vlines(x=stats['NPV'].mean(), ymin=0, ymax=1, linestyles='dashed', colors='r', label='Mean NPV (Stochastic)')
ax.legend()
ax.set_ylim(0, 1)
plt.show()